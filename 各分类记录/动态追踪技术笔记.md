...
* 8、`bpftrace -e 'tracepoint:sched:sched* { @[probe] = count(); } interval:s:5 { exit(); }'`
...
* 9、`bpftrace -e 'profile:hz:99 { @[kstack] = count(); }'`
...
[Bdoctor V3.2.2文档](https://dbdoctor1.hisensecloud.com/modules/dbDoctor/mdPreview/index.html?readme=help#/mdManageDocument/6.1.1-Quick-Install?id=dbdoctor-v322%e6%96%87%e6%a1%a3)
...
安装后，打印了地址和测试账号，浏览器打开登录即可

Admin用户：用来修改配置和相关模板；
DBA用户：用来查看各类统计

```sh
[root@xdlinux ➜ dbdoctor-3.2.2 ]$ ./dbd -I
...
┌───────────────────────────────────────────────────────────────────────────────┐
...
│                                                                               │
│ WebSite:  http://192.168.1.150:13000/#/login                                  │
│ DBA User:     tester                                                          │
...
└───────────────────────────────────────────────────────────────────────────────┘
2024-07-06 02:44:28.776741186 [INFO] [dbd]: add and set demo, wait a moment......
...
```sh
[root@xdlinux ➜ dbdoctor-3.2.2 ]$ ./dbd -I
2024-07-06 02:44:03.074085229 [INFO] [dbd]: Command Tool Version 3.2.2,Handler Command: install
2024-07-06 02:44:03.165316045 [INFO] [dbd]: current_path available_space  is 56GB, is valid, to do next~
2024-07-06 02:44:03.168793025 [WARN] [dbd]: ulimit -n is lower than 1025,suggest set nofile greater than 10240
2024-07-06 02:44:03.172591248 [INFO] [dbd]: stand-alone mode,all service will install in one host
2024-07-06 02:44:03.260559185 [INFO] [dbd]: HOST_IP: 192.168.1.150
2024-07-06 02:44:03.265458313 [INFO] [dbd]: AGENT port: 22888
2024-07-06 02:44:03.271378224 [INFO] [dbd]: SAMPLE_PORT port: 8080
2024-07-06 02:44:03.277311000 [INFO] [dbd]: PI_PORT port: 13000
2024-07-06 02:44:03.292317763 [INFO] [dbd]: ALGO_PORT port: 8999
2024-07-06 02:44:03.298394178 [INFO] [dbd]: COST_PORT port: 3606
2024-07-06 02:44:03.304070563 [INFO] [dbd]: COST57_PORT port: 3706
2024-07-06 02:44:03.309554407 [INFO] [dbd]: COST_PG11_PORT port: 5532
2024-07-06 02:44:03.315576360 [INFO] [dbd]: COST_PG14_PORT port: 5632
2024-07-06 02:44:03.321373411 [INFO] [dbd]: UNITE_PORT port: 15010
2024-07-06 02:44:03.327001325 [INFO] [dbd]: KAFKA_NODE_PORT port: 9092
2024-07-06 02:44:03.332903684 [INFO] [dbd]: KAFKA_CONTROLLER_PORT port: 19093
2024-07-06 02:44:03.338496582 [INFO] [dbd]: MYSQL_NODE_PORT port: 3306
2024-07-06 02:44:03.517677262 [INFO] [dbd]: creating agent package, wait a moment......
2024-07-06 02:44:03.862110020 [INFO] [dbd]: stand-alone mode starting......
✔ mysql start
✔ kafka start
✔ dra-algo-ml start
✔ dra-pi start
...
方式2、docker拉镜像（阿里云ACR），只试了下拉镜像

```sh
[root@xdlinux ➜ dbdoctor ]$ docker pull registry.cn-zhangjiakou.aliyuncs.com/dbdoctor/dbdoctor:3.2.2_x86
3.2.2_x86: Pulling from dbdoctor/dbdoctor
54bca87bcf72: Pulling fs layer 
552e793cbcaf: Pulling fs layer 
...
ccdf6753f218: Pull complete 
c3e689d80b44: Pull complete 
bd41225cca62: Pull complete 
Digest: sha256:7c8378723188a2dbb48260ef0dd4fedee3c74d2a2114e404d28be9dbc4078f8d
Status: Downloaded newer image for registry.cn-zhangjiakou.aliyuncs.com/dbdoctor/dbdoctor:3.2.2_x86
registry.cn-zhangjiakou.aliyuncs.com/dbdoctor/dbdoctor:3.2.2_x86
[root@xdlinux ➜ dbdoctor ]$ docker images 
REPOSITORY                                               TAG         IMAGE ID       CREATED         SIZE
registry.cn-zhangjiakou.aliyuncs.com/dbdoctor/dbdoctor   3.2.2_x86   123fd4b70413   2 days ago      6.85GB
```