...
typora 开源平替
* （推荐）[Markpad](https://github.com/sftwrdotdev/Markpad/releases)：Rust + Tauri，左侧TOC大纲、不支持目录列表展示
* [marklight](https://github.com/xiaodou997/marklight/releases)：Rust + Tauri，目录展示丰富一些
    速度都挺快，资源占用情况，基本都是：`50MB`核心程序占用 + `120MB` tauri占用。
* [ghostwriter](https://github.com/KDE/ghostwriter)：纯QT渲染，占用低
